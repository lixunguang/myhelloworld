...
public:
    ...
    Qtitan::RibbonPage* pageContext_;
...
#if defined(QTN_TEST_ContextTab)
    THIS->pageContext_ = rib->insertPage(1, tr("Test tab"));
    THIS->pageContext_->setContextColor(RibbonPage::ContextColorRed);
    THIS->pageContext_->setContextTitle(tr("Test tab"));
#endif // QTN_TEST_ContextTab
...
{
#if defined(QTN_TEST_ContextTab)
    if (THIS->pageContext_)
    {
        delete THIS->pageContext_;
//        rib->removePage(THIS->pageContext_);
        THIS->pageContext_ = Q_NULL;
    }
#endif // QTN_TEST_ContextTab
...
//    THIS->editX_->setEnabled(false);
//    THIS->editY_->setEnabled(false);
