...
//    uiDialog.tabWidget->setTabPosition(QTabWidget::West);
    ...
    button1->setText(QLatin1String("Button1"));
    ...
    button2->setText(QLatin1String("Button2"));
    button2->setToolButtonStyle(Qt::ToolButtonTextBesideIcon);
    button2->move(90, 10);
/*
    QToolButton* button3 = new QToolButton(uiDialog.tab_2);
    button3->setArrowType(Qt::DownArrow);
    button3->move(180, 10);
*/
    dlg.exec();
}
...
void Widgets::updateTheme(QAction* act)
{
    ...
    if (m_officeStyle)
    {
        ...
        else if (act == m_act2013WhiteTheme)
