...
static const qt_meta_stringdata_Qtitan__PopupColorButton_t qt_meta_stringdata_Qtitan__PopupColorButton = {
    {
QT_MOC_LITERAL(0, 0, 24), // "Qtitan::PopupColorButton"
QT_MOC_LITERAL(1, 25, 12), // "colorChanged"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 5) // "color"

    },
    "Qtitan::PopupColorButton\0colorChanged\0"
    "\0color"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Qtitan__PopupColorButton[] = {
...
void Qtitan::PopupColorButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (PopupColorButton::*_t)(const QColor & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&PopupColorButton::colorChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Qtitan::PopupColorButton::staticMetaObject = {
    { &QToolButton::staticMetaObject, qt_meta_stringdata_Qtitan__PopupColorButton.data,
      qt_meta_data_Qtitan__PopupColorButton,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *Qtitan::PopupColorButton::metaObject() const
{
...
int Qtitan::PopupColorButton::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void Qtitan::PopupColorButton::colorChanged(const QColor & _t1)
{
