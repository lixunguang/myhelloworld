...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Qtitan__OfficePopupMenu_t, stringdata0) + ofs \
...
void Qtitan::OfficePopupMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< bool*>(_v) = _t->isGripVisible(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setGripVisible(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
...
void *Qtitan::OfficePopupMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Qtitan__OfficePopupMenu.stringdata0))
