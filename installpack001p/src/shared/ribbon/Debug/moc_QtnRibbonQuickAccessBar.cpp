...
void Qtitan::RibbonQuickAccessBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (RibbonQuickAccessBar::*_t)(QMenu * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RibbonQuickAccessBar::showCustomizeMenu)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Qtitan::RibbonQuickAccessBar::staticMetaObject = {
    { &QToolBar::staticMetaObject, qt_meta_stringdata_Qtitan__RibbonQuickAccessBar.data,
      qt_meta_data_Qtitan__RibbonQuickAccessBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
